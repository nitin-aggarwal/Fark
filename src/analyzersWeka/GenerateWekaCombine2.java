...
/**
 * Combined UNIGRAM POS, Syntactic and other combined syntactic features
 */
public class GenerateWekaCombine2 
{
	...
	public static void compute(String dest, String uniq, long rcd, String[] category) throws NumberFormatException, IOException, SQLException, ClassNotFoundException
	{
		...
		// Create a linked list for all the UNIGRAM POS distinct features
		try	{
	...
	public static void main(String args[])
	{
		try {
			...
			compute("Combine3.arff","UnigramPOS5000",5000,"amusing cool interesting obvious".split(" "));
