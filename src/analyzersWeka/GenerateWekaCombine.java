...
/**
 * Combined UNIGRAM POS features and cohesion features
 * @author nitin
 *
 */
public class GenerateWekaCombine 
{
	...
	public static void main(String args[])
	{
		try {
			...
			compute("Combine1.arff","UnigramPOS5000","unigramPOS",5000,"amusing cool interesting obvious".split(" "));
